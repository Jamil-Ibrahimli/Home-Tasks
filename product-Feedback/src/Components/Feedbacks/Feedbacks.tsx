        ...
        <>
            <div className={styles.filter}>
                ...
                <div className={styles['filter-board']}>
                    ...
                    <ul className={styles['filter-board_list']}>
            ...
            <div className={classNames(styles['feedback-container'],
                { [styles['feedback-container-active']]: isActiveModal })}>

                <div className={styles['feedback-container_header']}>
                    <div className={styles['feedback-container_header_info']}>
                ...
                {value.length == 0 ? <div className={styles['feedback-empty']}>
            ...
            <InputModal activModal={isActiveModal} setIsActiveModal={setIsActiveModal}/>
